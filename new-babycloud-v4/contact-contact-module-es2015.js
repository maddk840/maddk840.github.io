...
ContactComponent.ɵfac = function ContactComponent_Factory(t) { return new (t || ContactComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](ngx_wow__WEBPACK_IMPORTED_MODULE_1__["NgwWowService"])); };
ContactComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: ContactComponent, selectors: [["app-contact"]], decls: 67, vars: 19, consts: [["id", "contact", 1, "contact"], [1, "container"], [1, "row", "d-flex", "justify-content-center", "contact-module"], [1, "get-in-touch", "order-2", "order-lg-1"], [1, "col-10", "mr-auto", "ml-auto", "mr-lg-0", "ml-lg-0", "d-flex", "d-lg-inline", "justify-content-center", "p-0"], [1, "ml-lg-3"], [1, "phone"], [1, "fa", "fa-phone", "icon-dark"], [1, "address"], ["aria-hidden", "true", 1, "fa", "fa-thumbtack", "icon-dark"], ["aria-hidden", "true", 1, "fa", "fa-thumbtack", "hidden-icon"], [1, "email"], [1, "fa", "fa-envelope", "icon-dark"], [3, "href"], [1, "contact-us", "order-1", "order-lg-2"], [1, "col-12", "mx-auto"], [1, "well", "well-sm"], ["action", "", "method", "post", 1, "form-horizontal"], [1, "col-12"], [1, "form-group"], [3, "value"], ["value", "demo"], ["value", "quote"], ["value", "work"], ["value", "other"], ["id", "name", "name", "name", "type", "text", "placeholder", "Name", 1, "form-control"], ["id", "email", "name", "email", "type", "text", "placeholder", "Email", "required", "", 1, "form-control"], ["id", "message", "name", "message", "placeholder", "Message", "rows", "5", 1, "form-control"], [1, "col-md-12", "text-left"], ["mat-flat-button", "", "color", "accent", "type", "submit", 1, "link-button", 3, "click"]], template: function ContactComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ContactComponent_Template_button_click_64_listener() { return ctx.submit(); });
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](ContactModule, { declarations: [_contact_component__WEBPACK_IMPORTED_MODULE_4__["ContactComponent"]], imports: [_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"], _angular_router__WEBPACK_IMPORTED_MODULE_7__["RouterModule"], _shared_shared_module__WEBPACK_IMPORTED_MODULE_3__["SharedModule"],
        _angular_forms__WEBPACK_IMPORTED_MODULE_2__["ReactiveFormsModule"],
        _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormsModule"],
        // 3rd party
        ngx_page_scroll__WEBPACK_IMPORTED_MODULE_5__["NgxPageScrollModule"],
