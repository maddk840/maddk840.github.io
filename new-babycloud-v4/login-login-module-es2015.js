...
LoginComponent.ɵfac = function LoginComponent_Factory(t) { return new (t || LoginComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](ngx_wow__WEBPACK_IMPORTED_MODULE_1__["NgwWowService"])); };
LoginComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: LoginComponent, selectors: [["app-login"]], decls: 14, vars: 0, consts: [[1, "header-invert"], ["id", "login", 1, "login"], [1, "container-fluid"], [1, "row"], [1, "col-10", "offset-1", "d-flex", "align-items-center"], [1, "col-1"], [1, "login-form"]], template: function LoginComponent_Template(rf, ctx) { if (rf & 1) {
