...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["logger-logger-module"], {
  ...
  /***/
  function srcAppLoggerLoggerMainLoggerMainComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "LoggerMainComponent", function () {
      return LoggerMainComponent;
    });
    /* harmony import */
    ...
    function LoggerMainComponent_div_13_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function LoggerMainComponent_ng_template_14_Template(rf, ctx) {
      if (rf & 1) {
    ...
    var LoggerMainComponent = /*#__PURE__*/function () {
      function LoggerMainComponent(breakpointObserver) {
        var _this = this;

        _classCallCheck(this, LoggerMainComponent);

        this.bMobile = false;
        breakpointObserver.observe('(max-width: 375px)').subscribe(function (result) {
          _this.bMobile = result.matches;
        });
      }

      _createClass(LoggerMainComponent, [{
        key: "ngOnInit",
    ...
    LoggerMainComponent.ɵfac = function LoggerMainComponent_Factory(t) {
      return new (t || LoggerMainComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_cdk_layout__WEBPACK_IMPORTED_MODULE_1__["BreakpointObserver"]));
    };

    LoggerMainComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      type: LoggerMainComponent,
      selectors: [["app-logger-main"]],
      decls: 16,
      vars: 8,
      consts: [["id", "logger-main", 1, "logger-main"], [1, "container-fluid"], [1, "row"], [1, "col-10", "col-md-8", "col-lg-7", "mx-auto", "d-flex", "align-items-end", "align-items-md-center", "justify-content-center"], ["data-wow-duration", "1s", 1, "logger-image", "pr-0", "pr-md-5", "pt-md-5", "mt-5", "wow", "fadeInDown"], ["src", "assets/images/logger/render.png", "alt", "3d render of the logger"], ["data-wow-duration", "0.5s", "data-wow-delay", "0.25s", 1, "col-11", "mx-auto", "col-lg-5", "d-flex", "align-items-start", "justify-content-center", "flex-column", "wow", "fadeInRight"], ["class", "logger-buttons pt-4 mb-5 mb-lg-0", 4, "ngIf", "ngIfElse"], ["mobile", ""], [1, "logger-buttons", "pt-4", "mb-5", "mb-lg-0"], ["mat-flat-button", "", "href", "#", 1, "mt-4", "link-button", 3, "routerLink", "state"], [1, "logger-buttons", "pt-4"], ["href", "#", 1, "mt-4", "link-button-mobile", 3, "routerLink", "state"]],
      template: function LoggerMainComponent_Template(rf, ctx) {
        if (rf & 1) {
  ...
  /***/
  function srcAppLoggerLoggerMoreLoggerMoreComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "LoggerMoreComponent", function () {
      return LoggerMoreComponent;
    });
    /* harmony import */
    ...
    function LoggerMoreComponent_div_1_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function LoggerMoreComponent_ng_template_2_Template(rf, ctx) {
      if (rf & 1) {
    ...
    var LoggerMoreComponent = /*#__PURE__*/function () {
      function LoggerMoreComponent(breakpointObserver) {
        var _this2 = this;

        _classCallCheck(this, LoggerMoreComponent);

        this.bMobile = false;
        breakpointObserver.observe('(max-width: 576px)').subscribe(function (result) {
          _this2.bMobile = result.matches;
        });
      }

      _createClass(LoggerMoreComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {}
      }]);
    ...
    LoggerMoreComponent.ɵfac = function LoggerMoreComponent_Factory(t) {
      return new (t || LoggerMoreComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_cdk_layout__WEBPACK_IMPORTED_MODULE_1__["BreakpointObserver"]));
    };

    LoggerMoreComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      type: LoggerMoreComponent,
      selectors: [["app-logger-more"]],
      decls: 4,
      vars: 2,
      consts: [["id", "logger-more", 1, "logger-more"], ["class", "container-fluid", 4, "ngIf", "ngIfElse"], ["mobile", ""], [1, "container-fluid"], [1, "row"], [1, "col-8", "mx-auto"], [1, "col-3", "col-lg-2", "offset-lg-1"], ["src", "assets/images/logger/documentation.svg", "alt", "documentation icon - image of book with settings and code icons on it"], [1, "col-8", "offset-1"], ["mat-flat-button", "", 1, "mt-4", "link-button", 3, "routerLink"], [1, "row", "py-5", "my-5"], ["src", "assets/images/logger/github.svg", "alt", "github icon"], ["src", "assets/images/logger/quote.svg", "alt", "quote icon - document with euro sign and calculator"], ["mat-flat-button", "", 1, "mt-4", "link-button", 3, "routerLink", "state"], [1, "col-8", "mx-auto", "pb-3", "more-image"], [1, "col-12", "mx-auto", "text-center"], ["mat-flat-button", "", 1, "mt-4", "link-button", 3, "href"]],
      template: function LoggerMoreComponent_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "section", 0);
  ...
  /***/
  function srcAppLoggerLoggerSpecsLoggerSpecsComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "LoggerSpecsComponent", function () {
      return LoggerSpecsComponent;
    });
    /* harmony import */
    ...
    function LoggerSpecsComponent_div_5_Template(rf, ctx) {
      if (rf & 1) {
    ...
    var LoggerSpecsComponent = /*#__PURE__*/function () {
      function LoggerSpecsComponent(translate) {
        _classCallCheck(this, LoggerSpecsComponent);
      ...
      _createClass(LoggerSpecsComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {
          var _this3 = this;

          this.translate.get('LOGGER.SPECS.SPEC').subscribe(function (res) {
    ...
    LoggerSpecsComponent.ɵfac = function LoggerSpecsComponent_Factory(t) {
      return new (t || LoggerSpecsComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_ngx_translate_core__WEBPACK_IMPORTED_MODULE_1__["TranslateService"]));
    };

    LoggerSpecsComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      type: LoggerSpecsComponent,
      selectors: [["app-logger-specs"]],
      decls: 6,
      vars: 1,
      consts: [["id", "logger-specs", 1, "logger-specs"], [1, "container-fluid"], [1, "row"], [1, "col-12", "d-flex", "align-items-center", "justify-content-center"], [1, "specs-container", "d-flex", "align-items-center", "justify-content-center"], ["class", "spec d-flex align-items-center justify-content-center flex-column wow zoomIn", 4, "ngFor", "ngForOf"], [1, "spec", "d-flex", "align-items-center", "justify-content-center", "flex-column", "wow", "zoomIn"], [1, "spec-image"], [3, "src", "alt"]],
      template: function LoggerSpecsComponent_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "section", 0);
  ...
  /***/
  function srcAppLoggerLoggerComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var _logger_main_logger_main_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ./logger-main/logger-main.component */
    "./src/app/logger/logger-main/logger-main.component.ts");
    /* harmony import */


    var _logger_specs_logger_specs_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    /*! ./logger-specs/logger-specs.component */
    "./src/app/logger/logger-specs/logger-specs.component.ts");
    /* harmony import */


    var _logger_more_logger_more_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ./logger-more/logger-more.component */
    "./src/app/logger/logger-more/logger-more.component.ts");
    /* harmony import */
    ...
    var LoggerComponent = /*#__PURE__*/function () {
      function LoggerComponent(wowService) {
    ...
    LoggerComponent.ɵfac = function LoggerComponent_Factory(t) {
      return new (t || LoggerComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](ngx_wow__WEBPACK_IMPORTED_MODULE_1__["NgwWowService"]));
    };
  ...
  /***/
  function srcAppLoggerLoggerModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var _logger_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    /*! ./logger.component */
    "./src/app/logger/logger.component.ts");
    /* harmony import */
    ...
    var _logger_main_logger_main_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
    /*! ./logger-main/logger-main.component */
    "./src/app/logger/logger-main/logger-main.component.ts");
    /* harmony import */


    var _logger_specs_logger_specs_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
    /*! ./logger-specs/logger-specs.component */
    "./src/app/logger/logger-specs/logger-specs.component.ts");
    /* harmony import */


    var _logger_more_logger_more_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
    /*! ./logger-more/logger-more.component */
    "./src/app/logger/logger-more/logger-more.component.ts");
    /* harmony import */
    ...
    LoggerModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineNgModule"]({
      type: LoggerModule
    });
    LoggerModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({
      factory: function LoggerModule_Factory(t) {
    ...
    (function () {
      (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](LoggerModule, {
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](LoggerModule, [{
...
//# sourceMappingURL=logger-logger-module-es5.js.map