...
function closeButton(){
    console.log("clicked!");
    if($( ".tableClass" ).hasClass( "closed" )){
        $( ".tableClass" ).removeClass( "closed" ).addClass( "opened" );
        $( ".navSpacer" ).removeClass( "closed" ).addClass( "opened" );
        $( ".closeButton" ).removeClass( "closed" ).addClass( "opened" );
    }
    else if($( ".tableClass" ).hasClass( "opened" )){
        $( ".tableClass" ).removeClass( "opened" ).addClass( "closed" );
        $( ".navSpacer" ).removeClass( "opened" ).addClass( "closed" );
        $( ".closeButton" ).removeClass( "opened" ).addClass( "closed" );
    }
}
